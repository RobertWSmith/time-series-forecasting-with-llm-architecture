...
\subsection{Chronos-2}
    ...
    model learns to infer inter-dependencies dynamically at inference time, without requiring task-specific architectural
    ...
    Inputs are robustly standardized using a $sinh^-1$ transformation to stabilize heavy-tailed distributions, augmented
